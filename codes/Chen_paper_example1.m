...
%  D^(1/3)u(t) + t^(1/3)*u(t) = 1.5*t^(2/3)/Γ(2/3) + t^(4/3)           
...
A = diag(t.^(1/3));                             % coefficient function matrix at the collocation points
f = (1.5/(gamma(2/3))).*t.^(2/3) + t.^(4/3);    % function values at the collocation points
c = f/(H + P_alpha*H*A);
